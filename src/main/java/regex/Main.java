...
public class Main {
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Pattern: at least one character before @, then either @mail.utoronto.ca or @utoronto.ca
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Pattern: any characters, then a capital letter, then any characters, then the same capital letter again
